...
<a href="/home">home</a>
  ...
  <%--<c:forEach var="country" items="${countries}"/>--%>
        ...
        <table align="center" >
            <tr align="center">
                <td>brand</td> <td>description</td> <td>name</td> <td>age</td> <td>price</td> <td>country</td>
                <td>sex</td> <td>size</td>
            </tr>
            <c:forEach var="clothing" items="${clothin}">
            <tr align="center">
   <td>${clothing.brand}</td> <td>${clothing.description}</td> <td>${clothing.name}</td> <td>${clothing.age}</td> <td>${clothing.price}</td>
                <td>${clothing.country.name}</td> <td>${clothing.sex}</td> <td>${clothing.size}</td>
